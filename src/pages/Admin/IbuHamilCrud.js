...
function IbuHamilCrud() {
  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await axios.post('https://carebot.tifpsdku.com/backend/ibu_hamil', newData);
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`https://carebot.tifpsdku.com/backend/ibu_hamil/${editId}`, newData);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://carebot.tifpsdku.com/backend/ibu_hamil/delete/${id}`);
